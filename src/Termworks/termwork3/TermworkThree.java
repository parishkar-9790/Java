...
public class TermworkThree {
    public static void main(String[] args) {
        MyBankAccount a1 = new MyBankAccount("SB","Parishkar Singh","Belagavi",1000);
        a1.depositAmt(1000.0);
        a1.withdrawAmt(5000.0);
        a1.computeInterest();
        System.out.println("");
        MyBankAccount a2 = new MyBankAccount("RD","Piyush Airani","Pune",15000);
        a2.computeInterest();
        MyBankAccount a3 = new MyBankAccount("FD","Chahak Kedawat","Jaipur",10000);
